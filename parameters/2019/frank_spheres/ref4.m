%
% Frank sphere exact test on 320x320 mesh.
%
...
P.nIter = 80;                   % Number of main loop iterations
...
P.Nref = 4;                 % Number of mesh refinement rounds
...
P.draw_step = 8;                  % Plot every nth iteration
