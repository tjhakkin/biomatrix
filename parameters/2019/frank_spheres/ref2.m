%
% Frank sphere exact test on 160x160 mesh.
%
...
P.nIter = 40;                   % Number of main loop iterations
...
P.Nref = 2;                 % Number of mesh refinement rounds
...
P.draw_step = 4;                  % Plot every nth iteration
