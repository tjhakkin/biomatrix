P.template = '../data/2019/Fig6B/hum215_braces.mat';

% Neumann boundary means no-flux ('wall'), Dirichlet is a sink/source.
P.boundary = 'Mixed';         % Outer boundary condition type
P.bc = 0;                      % Boundary condition (if P.boundary = 'Dirichlet')
...
P.L = 2.2;                      % Stefan constant
P.eps_C = 0.00001;              % Surface tension coefficient
P.source = 75;                  % Constant nutrient source in liquid

P.nIter = 4;                    % Number of main loop iterations
...
P.cmap = [0:1/63:1]' * [0.75294 0.75294 0.75294];  % Energy/nutrient visualization
